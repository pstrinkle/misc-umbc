...
# Semester: Spring 2009# Professor: Dr Nicholas# Student: Patrick Trinkle <tri1@umbc.ed># Date: 20090204# Title: HTMLParser Object Definition# Note: This was far trickier than doing it in C# or Perl or C, #       but has provided a good learning experience#       Also this method is rather slow.  Doing it as a procedural #       script might be faster as it won't have to instantiate objects, #       etc.  But since speed wasn't a primary concern; #       I felt this approach was appropriate.require 'fileutils'
