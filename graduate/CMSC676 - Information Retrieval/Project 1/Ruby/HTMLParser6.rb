...
# Tokens are terminated either by the start of a tag or: ' ', '\n', '\r', '\t', ',', '-', '"', '[', ']', ':', ';', '/', '+', '='
...
puts "Writing out Complete Term List"
...
temporaryList = totalTokens.values
puts "Count: " + temporaryList.size.to_s
temporaryList.sort
i = 0
while i < temporaryList.size do
