...
# This is my trying to make the stupid thing fill properly.
bottomshell = Tkinter.Frame(root)
bottomshell.grid(row=2, column=0, sticky="news")

bottom = Tkinter.Frame(bottomshell)
# This should be it filling, yet it doesn't quite work.
