/* testing Print
 * must have GraduationPlan.o Semester.o Course.o New.o ProjAux.o View.o Print.o
 * must also have all *.h Files, and a GraduationPlan.txt file built
 * 
 * compile g++ -Wall -ansi -o testView testView.cpp GraduationPlan.o Semester.o Course.o New.o ProjAux.o View.o Print.o
 */
